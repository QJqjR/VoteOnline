...
<body>
    <nav id="nav">
        ...
        <h1 class="logo"></h1>
               <ul class="link">
                ...
                <li class="active"><a href="#">音乐投票</a></li>
    ...
    <div id="search">
        <div class="center">
        <input type="text" class="search" placeholder="请输入旅游景点或城市" name="findMusic"/>
    ...
    <div id="tour">
         <!-- 标题 -->
             <section class="center">
					...
					<c:redirect url="music"></c:redirect>
					</c:if>
                    
                    <!-- 1 -->
                    <form action="music" method="post">
                    <c:forEach var="mus" items="${requestScope.musicList}"
							varStatus="i" step="1">
                    <figure>
                        <img src=${mus.sImage}> 
                        ...
                        <figcaption>  
                    	 ...
                    	 <c:if test="${mus.sId!=12 }">
                    	  <a href="musicVote?sessionScope.name"><strong>&lt;${mus.sType}&gt; </strong></a>
                    	  </c:if>
                    	  <c:if test="${mus.sId==12 }">
                    	   <a href="show.jsp"><strong>&lt;${mus.sType}&gt; </strong></a>
                    	  </c:if>
                    	</c:if>
                    	<c:if test="${ sessionScope.name==null}">
                    	  <a href="login"></a>
                        ...
                        <div>
                                ...
                                <div class="price"><strong>${mus.sBrowseTotal}人</strong></div>
                            </div>
                            <div>
                                <div class="sta">参与人数</div>
                                <div class="price"><strong>${mus.sParticipate}人</strong></div>
                            </div>
                            <div>
                                <div class="sta">累计投票数</div>
                                <div class="price"><strong>${mus.sVotetotal}票</strong></div>
                            </div>                       
                        <div class="type">
                            ${mus.sTitle}
                            </div>
