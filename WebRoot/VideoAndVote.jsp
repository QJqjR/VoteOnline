    ...
    <nav id="nav">
        ...
        <h1 class="logo"></h1>
               <ul class="link">
                ...
                <li class="active"><a href="videoVote.jsp">视频投票</a></li>
    ...
    <div id="tour">
         <!-- 标题 -->
             <section class="center">
					...
					<c:redirect url="videoVote"></c:redirect>
					</c:if>
                    
                    <!-- 1 -->
                    <form action="videoVote" method="post">
                    <c:forEach var="vid" items="${requestScope.vidList}"
							varStatus="i" step="1">
                    <figure>
                       <video id="myVideo" width="340" height="180" poster=${vid.sImage} controls=""> 
                        ...
                        <!-- 描述照片 -->
                        <figcaption>
                       	<strong style="padding-left: 50px;">&lt;${vid.sType}&gt; </strong>
                        </figcaption>
                        <div>
                                <div class="sta" ><a href="addVZan?id=${vid.sId }"><i  class="fa fa-heart-o" id="before" onclick="ch()" aria-hidden="true"></i></a></div>
