    ...
    <div id="tour">
         <!-- 标题 -->
             <section class="center">
					...
					<c:redirect url="musicVote"></c:redirect>
					</c:if>
                    
                    <!-- 1 -->
                    <form action="musicVote" method="post">
                    <c:forEach var="mus" items="${requestScope.musList}"
							varStatus="3" step="1">
                    <figure>
                        <img src=${mus.sImage}> 
                        <embed height="25" width="340" src=${mus.sMusic} autostart=false/>
                        <!-- 描述照片 -->
                        <figcaption>
                       	<strong style="padding-left: 50px;">&lt;${mus.sType}&gt; </strong>
                        </figcaption>
                        <div>
                                <div class="sta" ><a href="addMZan?id=${mus.sId }"><i  class="fa fa-heart-o" id="before" onclick="ch()" aria-hidden="true"></i></a></div>
