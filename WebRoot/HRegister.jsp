...
<body style="background-image: url(img/school1.jpg);">
        <nav id="nav">
                <section class="cen">
                <h1 class="logo"></h1>
						   <ul class="link">
                			...
                			<li><a href="HLogin.jsp">登录</a></li>
               				<li class="active"><a href="HRegister.jsp">注册</a></li>
						</ul>
                </section>
        </nav>
        <div class="login-form">
           ...
           <form action="Hregister" method="post" onsubmit="return checkLogin()">
